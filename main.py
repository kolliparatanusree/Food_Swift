...
class Home:
    def __init__(self, root):
        ...
        self.bg   = Image.open('..\\assests\\food.jpg')
    ...
    def login_s(self):
        ...
        self.goto_register.place(x = 5, y = 750)
    ...
    def warden(self):
        ...
        cursor.execute('select * from students_details order by date desc;')
        self.data = cursor.fetchall()
        self.x1 = 10
        self.y1 = 100
        ...
        self.btn = Button(self.msg_frame, text = 'Reset',font=('Courier New', 18, 'bold'), bg = 'pink', command= self.reset, cursor = 'hand2')
    ...
    def student(self):
        ...
        self.bg   = Image.open('..\\assests\\details.jpg')
        self.bg = self.bg.resize((1700, 950))
        self.bg = ImageTk.PhotoImage(self.bg)
    ...
    def student_details(self):
        ...
        if len(self.phonenum) != 10 or self.name == '' or self.hostel_name == '' or self.regno == '' or self.prob == '':
            ...
            self.query = "insert into students_details(name,regno , hostel_name, phonenum,prob) values(%s,%s,%s,%s,%s)"
